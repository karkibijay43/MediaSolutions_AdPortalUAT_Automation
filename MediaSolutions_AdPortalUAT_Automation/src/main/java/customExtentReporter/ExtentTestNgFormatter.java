...
/**
 * This class houses the listener for the TestNG which generates the html report
 * by using Extent Report.
 */
public class ExtentTestNgFormatter implements ISuiteListener, ITestListener, IInvokedMethodListener, IReporter {
	...
	public ExtentTestNgFormatter() {
		...
		try {
			...
			reportPath = new File("/Users/p2815492/git/MediaSolutionsRepo/MediaSolutions_Automation/TestNGRegression_TestReport");
		}
		...
		File reportFile = new File(reportPath, "Regression_TestReport.html");
	...
	/**
	 * Adds a screen shot image file to the report. This method should be used only
	 * in the configuration method and the {@link ITestResult} is the mandatory
	 * parameter
	 *
	...
	/**
	 * Adds a screen shot image file to the report. This method should be used only
	 * in the {@link org.testng.annotations.Test} annotated method
	 *
	 * @param filePath The image file path
	 * @throws IOException {@link IOException}
	 */
	...
	/**
	 * Marks the node as failed. The node name should have been set already using
	 * {@link NodeName}
	 *
